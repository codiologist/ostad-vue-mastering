...
<template>
  <section :class="`counter__area counter__border-radius pb-${spacing} p-relative z-index-1`">
    <div class="counter__shape">
      <img class="counter__shape-11" src="@images/counter/5/counter-shape-1.png" alt="shape" />
      <img class="counter__shape-12" src="@images/counter/5/counter-shape-2.png" alt="shape" />
    </div>
    <div class="container">
      <div class="row">
      ...
      <div class="row gx-2">
        <div v-for="(item, i) in counter_data" :key="i" class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
          <div :class="`counter__item-5 counter__${item.bg} mb-30 wow zoomIn`" data-sal="slide-up" data-sal-delay="130"
            ...
            <div class="counter__no">
              <h4>
                <span class="counter">{{ item.num }}</span>{{ item.text }}
              </h4>
            </div>
          </div>
        </div>
