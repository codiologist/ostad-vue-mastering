...
<template>
  <section id="features" class="features__area p-relative z-index-1 grey-bg-7 pt-110 pb-90">
    <div class="features__shape">
      <img class="features__shape-1" src="@images/features/features-shape-1.png" alt="features__shape" />
      <img class="features__shape-2" src="@images/features/features-shape-2.png" alt="features__shape" />
      <img class="features__shape-3" src="@images/features/features-shape-3.png" alt="features__shape" />
      <img class="features__shape-4" src="@images/features/features-shape-4.png" alt="features__shape" />
      <img class="features__shape-5" src="@images/features/features-shape-5.png" alt="features__shape" />
    </div>
    <div class="container">
      ...
      <div class="row">
        <div v-for="item in feature_data" :key="item.id" class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div :class="`features__item ${item.color} transition-3 mb-30`" data-sal="slide-up" :data-sal-delay="item.delay"
