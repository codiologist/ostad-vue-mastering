...
import OffcanvasMenu from "@/layouts/header/OffcanvasMenu.vue";
...
<template>
                                ...
                                <div class="header__right-5 d-flex align-items-center justify-content-end">
                                    <div class="header__call d-none d-xl-flex align-items-center">
                                        ...
                                        <div class="header__call-content">
                                            <p>Consultation</p>
                                            <h4><a href="tel:+8801876594444">+88-018 7659 4444</a></h4>
                                        </div>
                                    </div>
                                    <div class="header__hamburger header__hamburger-5 ml-50 d-xl-none">
                                        <!-- <button @click="onChildClick" type="button" -->
    ...
    <!-- off canvas start -->
    <OffcanvasMenu ref="child" :isOffCanvasOpen="isMobileNavOpen" @closeOffcanvas="toggleMobileNav"/>
    <!-- off canvas end -->
</template>
