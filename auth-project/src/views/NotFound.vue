<template>
    <div>
        <div
            class="bg-indigo-100 w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
            <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-indigo-600">404</p>
                <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-600 mt-2">Page Not Found</p>
                ...
                <div class="flex ">
                    <div class="w-full px-3 mb-5">
                        <RouterLink to="/" class="flex items-center justify-center w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-6 pl-3 py-2 text-lg font-semibold">
                            <i class="mdi mdi-arrow-left text-white text-2xl mr-3"></i>
                            Go Back
                        </RouterLink>
                    </div>
                </div>
            ...
            <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
                <svg class="w-full text-indigo-600" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
