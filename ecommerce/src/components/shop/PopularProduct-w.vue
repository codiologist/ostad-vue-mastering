<script setup>
import { ref } from "vue";
import moduleName from '../../stores/ProductStore';
import SingleProduct from "./SingleProduct.vue";

const tabs = ref([ "Top Rated", "Best Selling", "Latest Products"])
...
function handleTabProduct(value) {
    ...
    if (value === "Top Rated") {
        product_items.value = productData.filter((item) => item.topRated);
    }
    if (value === "Best Selling") {
        product_items.value = productData.filter(
...
//         activeTab = value;
//         if (value === "Top Rated") {
//           product_items = productData.filter((item) => item.topRated);
//         }
//         if (value === "Best Selling") {
//           product_items = productData.filter(
//             (item) => item.bestSelling
//           );
//         }
//         if (value === "Latest Products") {
