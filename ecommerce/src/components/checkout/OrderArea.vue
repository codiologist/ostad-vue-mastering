    ...
    <div class="your-order mb-30 ">
        <div class="your-order-table table-responsive">
            <table>
                ...
                <tbody>
                    <tr class="cart_item" v-for="(item, index) in cart.items" :key="index">
        ...
        <div class="payment-method faq__wrapper tp-accordion">
            ...
            <div class="order-button-payment mt-20">
                <button v-if="authStore.isAuthenticated && cart.totalCartItems != 0" @click="handleOrderPlaced()" class="tp-btn">
                    Place order
                </button>
