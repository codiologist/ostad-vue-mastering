...
const username = ref('firoj@gmail.com');
                        ...
                        <div class="login__wrapper">
                            ...
                            <div class="login__form">
                                ...
                                <div class="login__input-wrapper">
                                    <div class="login__input-item">
                                        <div class="login__input">
                                            <input v-model="username" type="text" placeholder="Email or Username">
                                            <span>
                                        ...
                                        <span>
                                            <svg width="17" height="18" viewBox="0 0 17 18" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M11.1306 9.52505C10.9356 10.5826 10.0731 11.4451 9.01562 11.6401"
                                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M6.6025 10.8975L1 16.5" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M16.0009 1.5L10.3984 7.1025" stroke="currentColor"
                                ...
                                <div class="login__btn">
                                    <button @click="auth.authenticate(username, password)" class="tp-btn w-100">Sign
                                        In</button>
                                </div>
                                <!-- </form> -->
                                <!-- form end -->
                                <div class="login__social text-center">
                                    <h3 class="login__social-header">Don’t have an account?</h3>
                                </div>
