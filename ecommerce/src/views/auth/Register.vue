                        ...
                        <div class="login__wrapper">
                            ...
                            <div class="login__form">
                                ...
                                <div class="login__input-wrapper">
                                    <div class="login__input-item">
                                        <div class="login__input">
                                            <input v-model="credentials.username" type="text" placeholder="Full Name">
                                            <span>
                                ...
                                <div class="login__btn">
                                    <button @click="auth.register(credentials)" class="tp-btn w-100">Sign Up</button>
                                </div>
                                <!-- </form> -->
                                <!-- form end -->
                                <div class="login__social text-center">
                                    <h3 class="login__social-header">Have an account?</h3>
                                </div>
