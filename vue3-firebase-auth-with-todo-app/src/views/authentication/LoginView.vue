                ...
                <div class="w-full h-screen flex items-center md:w-4/6 xl:w-2/6  px-5  xl:px-10 2xl:px-20">
                    <div class="w-full">
                        ...
                        <div
                            ...
                            <p class="text-[13px] font-semibold">Email: firoj@gmail.com / Pass: *Abc123$</p>
                        </div>
                            ...
                            <div>
                                <div class="flex -mx-3 ">
                                    <div class="w-full px-3 mb-5">
                                        <label for="" class="text-base font-semibold px-1 text-indigo-600">Email <sup
                                        ...
                                        <div class="flex mt-1">
                                            ...
                                            <input v-model="credentials.email" type="email" @keypress="req = false"
                                ...
                                <div v-if="authStore.errorMessage !== null"
                                    class="flex items-center justify-center text-center mb-5">
